...
<% 
    ...
    string quanjing = string.Empty;
    if (ViewData["quanjing"] != null && ViewData["quanjing"] != string.Empty)
    {
        quanjing = gourl + "?url=" + Server.UrlEncode(ViewData["quanjing"].ToString());
...
<body>
    ...
    <iframe id="ifr_quanjing" src='<%=quanjing%>' width="100%" height="500" frameborder="0"
