		...
		<section class="show-body">
                        ...
                        { %>
                          ...
                          <dl class="s-my-dl">
                              ...
                              <dd>
                                  ...
                                  <span></span>删除</div>
                                  <div class="s-edit fr" onClick="javascript:window.location.href='/zhineng/addfapiao/<%=hotelid %>?key=<%=weixinID %>@<%=userWeiXinID %>&Id=<%=db.Rows[i]["Id"].ToString() %>&uId=<%=db.Rows[i]["userweixinId"].ToString() %>'" ><span></span>编辑</div>
                              </dd>
                          </dl>
                     ...
                     <div class="uc__account-info">
                           <div class="submit-btn sp">
                                <input type="button" class="btn-save" value="添加抬头" onClick="javascript:window.location.href='/zhineng/addfapiao/<%=hotelid %>?key=<%=weixinID %>@<%=userWeiXinID %>'" />
                           </div>
                     </div>
			</section>
