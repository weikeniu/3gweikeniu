...
<body class="o-f-auto">
    ...
    <% 
		...
		<section class="show-body sp">
			<section class="content2 sp">
     ...
     <%if (PayStatus != Convert.ToInt32(hotel3g.Models.EnumSupermarketPayStatus.AllReturn))
       {
		...
		<div class="yu-cw">
			...
			<p class="yu-f26r yu-w380r">剩下<span class="yu-ffd57a"></span>时间，如超市未支付订单将自动取消。</p>
		</div>
		<div class="kd-pic">
    ...
    <%  if (ViewData["AddressType"].ToString() != "酒店" && OrderStatus != Convert.ToInt32(hotel3g.Models.EnumSupermarketOrderStatus.WaitPay) && OrderStatus != Convert.ToInt32(hotel3g.Models.EnumSupermarketOrderStatus.WaitDeliver) && OrderStatus != Convert.ToInt32(hotel3g.Models.EnumSupermarketOrderStatus.Cancel))
        {%>
			...
			<a class="o-d-ico bl type3 yu-rmar25r" href="#"></a>
			<a class="yu-alignc yu-overflow" href="/Supermarket/Logistics/<%=ViewData["hotelId"] %>?key=<%=ViewData["weixinid"] %>@<%=ViewData["userweixinid"] %>&orderid=<%=ViewData["orderId"] %>">
				<div class="yu-f30r">
					<p class="yu-blue2 yu-bmar10r yu-rpad50r">
						<%=ed.context%>
					</p>
            ...
            <%}
               ...
               { %>
		<div class="yu-grid yu-alignc yu-tbpad30r yu-lpad40r yu-bor bbor">
			<a class="o-d-ico bl type2 yu-rmar25r" href="#"></a>
    ...
    <%  
		...
		<div class="yu-grid yu-alignc yu-tbpad30r yu-lpad40r">
			<a class="o-d-ico bl type1 yu-rmar25r" href="#"></a>
		...
		<div class="yu-pad20 yu-bglgrey yu-bor bbor">
         ...
         %>
                ...
                <% if (OrderStatus == Convert.ToInt32(hotel3g.Models.EnumSupermarketOrderStatus.Finish))
                   ...
                   <% if (!string.IsNullOrWhiteSpace(ed.context))
                      { %>
						<a href="/Supermarket/Logistics/<%=ViewData["hotelId"] %>?key=<%=ViewData["weixinid"] %>@<%=ViewData["userweixinid"] %>&orderid=<%=ViewData["orderId"] %>" class="yu-btn6 type1">查看物流</a>
                 <%}
                   } %>
