...
<body>
               ...
               <%=products.FeeInclude.Replace("\n","<br/>") %>						
				...
				<div class="yu-bgw yu-bmar20r">
					...
					<div class="yu-tb40r yu-grid yu-lrpad20r yu-bor bbor">
						...
						<div class="yu-w155r">
							<a class="phone-ico3 sp" href="tel:<%=ViewData["tel"]  %>"></a>
						</div>
					</div>
						...
						<div class="ewm yu-lmar20r yu-rmar28r">
							...
							<div class="yu-grid yu-alignc yu-bmar25r">
								<p class="p-pic yu-rmar28r sp"></p>
								<p class="yu-f36r yu-c66">长按识别二维码</p>
							</div>
							<dl class="yu-f26r">
								<dt class="yu-blue2">关注酒店官方公众号：</dt>
    ...
    <script>
        ...
        $(".buy-go").click(function () {
            ...
            window.location.href = '/Product/ProductConfirmOrder/<%=hotelid%>?key=<%=weixinID%>@<%=userWeiXinID%>&ProductId=<%=Request.QueryString["ProductId"]%>&tcId=' + tcId + '&buyAmount=' + $(".food-num").text() + '&stock=' + $("#stock").text().trim() + '&date=' + $("#select_date").val().trim();
