...
<body class="o-f-auto">
    ...
    <section class="order-d-top yu-pos-r bl">
		...
		<div class="kd-pic">
                       ...
                       <%}
                           ...
                           { %>                         
                               <img src="../../images/order-ico/yuyueb_03.jpg" />
                       <%}
    ...
    <section class="yu-bgw yu-bmar10 ">
		<div class="yu-grid yu-alignc yu-tbpad30r yu-lpad40r">
			<a class="o-d-ico type1 yu-rmar25r bl" href="#"></a>
    ...
    <section class="yu-bgw yu-bmar20r">
      ...
      <% string currlink = string.Format("window.location.href='/product/ProductList/{0}?key={1}@{2}'", hotelid, weixinID, userWeiXinID);
				...
				<li class="yu-grid yu-alignc yu-bmar10 yu-f40r">
					...
					<div>
                        ...
                        <% if (order.Ispay && list_tuan[i].Status == (int)WeiXin.Models.Home.ProductSaleOrderTuanStatus.预约成功)
                           ...
                           <% if (order.OrderStatus == (int)WeiXin.Models.Home.ProductSaleOrderStatus.取消)
                              {%>
                         	<a href="/product/ProductDetail/<%=hotelid%>?key=<%=weixinID%>@<%=userWeiXinID%>&ProductId=<%=order.ProductId%>" class="yu-btn6   type2 ">重新购买</a>
                                <%} %>
		...
		<div class="yu-h120r yu-grid yu-lrpad20r yu-alignc ">
				...
				<div class="yu-overflow">
					...
					<p class="yu-c99 yu-f22r">已优惠<%=toalCoupon %>元，可获<span class="yu-blue2"><%=order.Jifen %></span>积分</p>
				</div>
		</div>
