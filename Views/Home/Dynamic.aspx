...
<body>
    ...
    <div class="hotel__panel-index clearfix">
            ...
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="bg-img" style="background: url('<%=covers[i] %>'); background-size: 100% 100%;">
                        </div>
                    </div>
                    <%} %>
                </div>
        ...
        <!-- //链接导航 -->
        <div class="zone__menuLink<%=(ViewData["weixinID"].ToString().Equals("gh_94f9be27c20a")?" sp":"") %>">
            <div class="logo">
                <div class="inner h-bg">
                    <span>
                        <img src="<%=HotelInfo.HotelLog %>" /></span>
                </div>
            </div>
            <div class="grid">
                <div class="tel h-bg">
                ...
                <ul class="link clearfix">
                    <% string wkn_shareopenid = hotel3g.Models.DAL.PromoterDAL.WX_ShareLinkUserWeiXinId;
                       ...
                       { %>
                    <li><a class="h-bg" href="/user/Index/<%=ViewData["hId"] %>?key=<%=ViewData["weixinID"] %>@<%=ViewData["userWeiXinID"] %>">
                        会员中心</a></li>
                    <%}%>
                    <li><a class="h-bg" href="/Hotel/Info/<%=ViewData["hId"] %>?key=<%=ViewData["weixinID"] %>@<%=ViewData["userWeiXinID"] %>">
                        酒店介绍</a></li>
                    <li><a class="h-bg" href="/Hotel/Map/<%=ViewData["hId"] %>?key=<%=ViewData["weixinID"] %>@<%=ViewData["userWeiXinID"] %>">
                        酒店导航</a></li>
                    <li><a class="h-bg" href="/Hotel/Index/<%=ViewData["hId"] %>?key=<%=ViewData["weixinID"] %>@<%=ViewData["userWeiXinID"] %>">
                        客房预订</a></li>
                </ul>
            </div>
        </div>
