    ...
    <article class="full-page">	  
		...
		<section class="show-body">
			<section class="content2">
                     <p class="ca-nao-weak">洗衣服务</p>
				     <div class="ca-other-goods">
                           <ul>
                                <li class="ca-displayfx lasttimeselect"><span><h1>取衣时间</h1><i>*</i></span><input type="text" placeholder="请选择取衣服务时间"  id="lasttime" readonly="readonly" /><b></b></li>
        ...
        <section class="mask lasttime-mask">
            <div class="mask-bottom-inner yu-bgw">
                <p class="yu-h110r yu-l110r yu-textc yu-bor bbor yu-f34r">取衣时间</p>
    ...
    <script type="text/javascript">
        ...
        $('.btn-save').click(function () {
            ...
            $.ajax({
                ...
                type: 'post',
                data: { hotelId: '<%=hotelid %>', key: '<%=HotelCloud.Common.HCRequest.GetString("key")%>', servicetime: $("#lasttime").val().trim(), roomno: $("#roomno").val().trim(), phonenumber: $(".phonenumber").val().trim(), remark: $("#txt_remark").val().trim(), type: "2" },
                dataType: 'json',
