    ...
    <article class="full-page">	  
		...
		<section class="show-body">
			<section class="content2">
                     <p class="ca-nao-weak">叫醒服务</p>
				     <div class="ca-other-goods">
                           <ul>
                                <li class="ca-displayfx lasttimeselect"><span><h1>叫醒时间</h1><i>*</i></span><input type="text" placeholder="请选择叫醒时间"  id="lasttime" readonly="readonly" /><b></b></li>
                           ...
                           <div class="ca-why-remind">
                                 <p>提醒事由</p>
                                 <span><textarea placeholder="提醒事由" id="txt_remark" ></textarea></span>
                           </div>
                           <!--ca-why-remind end-->
                     </div>
                     <!--ca-other-goods end-->
        ...
        <section class="mask lasttime-mask">
            <div class="mask-bottom-inner yu-bgw">
                <p class="yu-h110r yu-l110r yu-textc yu-bor bbor yu-f34r">叫醒时间</p>
    ...
    <script type="text/javascript">
        ...
        $('.btn-save').click(function () {
            ...
            $.ajax({
                ...
                type: 'post',
                data: { hotelId: '<%=hotelid %>', key: '<%=HotelCloud.Common.HCRequest.GetString("key")%>', servicetime: $("#lasttime").val().trim(), roomno: $("#roomno").val().trim(), phonenumber: $(".phonenumber").val().trim(), remark: $("#txt_remark").val().trim(), type: "1" },
                dataType: 'json',
