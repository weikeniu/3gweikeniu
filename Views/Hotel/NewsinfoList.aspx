...
<head>
    ...
    <title><%=Request.QueryString["type"]=="1" ?   "攻略列表" : "活动列表" %></title>
...
.content2{padding-top:0;padding-bottom:40px}
.show-body{
margin-top:0;
padding-top: 0;}
</style>
                ...
                <% List<hotel3g.Models.HotelNews> Newlist = ViewData["news"] as List<hotel3g.Models.HotelNews>;
                   if (Newlist != null && Newlist.Count > 0)
                   {
                       ...
                       { %>
                       	...
                       	<li>
								<a href="/Hotel/NewsInfo/<%=item.HotelID %>?nid=<%=item.Id %>&key=<%=weixinID %>@<%=ViewData["userWeiXinID"] %>" class="yu-black">
