...
<body>
			...
			<section class="content2 yu-bpad120r">
				<div class="yu-bgw yu-bmar20r">
					<div class="yu-grid yu-tbpad40r yu-f36r yu-lrpad20r yu-alignc">
						...
						<a href="/ProductA/ProductDetail/<%=hotelid%>?key=<%=weixinID%>@<%=userWeiXinID%>&ProductId=<%=Request.QueryString["ProductId"] %>" class="close-ico type2"></a>
					</div>
    ...
    <script>
        ...
        $('.pay-btn').click(function () {
            ...
            $.ajax({
                url: '/ProductA/ProductPay/<%=hotelid %>?key=<%=weixinID %>@<%=userWeiXinID %>',
                type: 'post',
