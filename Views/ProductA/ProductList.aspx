...
<body>
    <article class="full-page">
       ...
       <%
        ...
        string desn = null;
        string logo = null;
        if (producdtList != null && producdtList.Count > 0) {
            title = producdtList[0].ProductName;
            desn = producdtList[0].EndTime + " 结束";
            logo = producdtList[0].MainPic;
        }
				...
				<ul class="booking-list">
                     <% foreach (var item in producdtList)
                        {  %>
								...
								<li>
                              <a href="/ProductA/ProductDetail/<%=hotelid %>?key=<%=weixinID %>@<%=userWeiXinID %>&ProductId=<%=item.Id %>">
