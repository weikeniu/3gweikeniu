...
<body>
           ...
           bool CanRegister = (bool)ViewData["CanRegister"];
            ...
            <% if (CanRegister)
	 		...
	 		<div class="yu-grid yu-alignc yu-bor bbor yu-h88r yu-rpad33r">
	 			...
	 			<p class="yzm-btn" id="sendcode" style="cursor:pointer;">获取验证码</p>
                 <p class='btn yzm-btn' id="P1" style="display:none;"><span id="timer" >30</span>秒后重发</p>
	 		</div>
    ...
    <input type="button" id="register"  class="yu-sub2 yu-h88r" value="提交" />
        </section>
    <%}
               else
               { %>
        ...
        $("#register").click(function () {
            ...
            $.post("/MemberCard/Register", prem, function (data, status) {
                if (data.state == 1) {
                    ...
                    setTimeout(function () {
                        var url = '/User/Index/<%=hid %>?key=<%=key %>';
