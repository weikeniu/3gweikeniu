...
<body>
    <article class="full-page">
		...
		<section class="show-body">
								...
								<li class="row2">
									<div class="inner flexbox">
                                       ...
                                       <% string showyzm = string.IsNullOrEmpty(memberEntity.Mobile) ? "" : "display:none"; %>
                                        ...
                                        <input type="button" class="btn-getCode style2"  id="sendcode" value="获取验证码"  style="<%=showyzm %> " />                                  
                                        <div class="btn-getCode style2" id="P1"  style="display:none">30秒后重新发送</div>
			...
			<!--底部-->
			<footer class="yu-grid fix-bottom yu-bor tbor yu-lpad10">
    ...
    <script>
        ...
        $("#btn_buy").click(function () {
            ...
            $.ajax({
                url: '/MemberCard/UserBuyMemberCard',
                type: 'post',
