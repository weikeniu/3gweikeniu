...
<body style="background: rgb(91, 43, 127); overflow-x: hidden;">
    ...
    <div class="banner">
        ...
        <div class="turnplate" style="background-image: url('../../images/turnplate-bg.png');
            ...
            <img class="pointer3" id="weixinphoto" src="<%=UserItem!=null?UserItem.photo+"#"+DateTime.Now.ToString("yyyyMMddHHmmssfff"):"../../images/daoshu/djs-bg.png" %>" />
        </div>
    </div>
    <div class="tips">
...
<div class="mask2" style="display:block;z-index: 9999">
		<div style="width: 100%;text-align: center;background:rgba(0,0,0,0.5);color:#fff;font:14px/24px microsoft yahei,simhei;margin-top:30%;height:18%;padding-top: 31%">
        <% if (UserItem != null)
           { %>
              已报名 <span style="padding:4px;outline:solid 1px #fff"><%=UserItem.name%></span>
        <%}%>
        <br /> 抽奖尚未开始<br>在此可观看抽奖过程</div>
	</div>
