...
<body style="background: #e62d2d; overflow-x: hidden;">
    ...
    <section class="main-sec">
		<div class="m-title"><h3>活动<%=  RandomLuckyDrawDeatil.edate < DateTime.Parse(DateTime.Now.ToString("yyyy-MM-dd HH:00:00")) ? "(已结束)" : "说明"%></h3></div>
		<div class="einfo">
    ...
    <section class="main-sec">
		...
		<div class="einfo">
            ...
            <p>参与奖：<%=RandomLuckyDrawDeatil.no0 %> 【<%=RandomLuckyDrawDeatil.no0num %>名】</p>
		</div>
	</section>
    <section class="main-sec">
    ...
    <div class="mask paize-select">
		<div class="inner">
			...
			<form>
			<div class="top-row">
				<span class="add-prize">+新增抽奖</span>
...
<li>
					...
					<li class="sp"><input type="button" value="抽奖" class="drawnobtn limit" /></li>				
