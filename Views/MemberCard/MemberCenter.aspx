 ...
 <%} %>
 		...
 		<div class="txt-bottom">
            ...
            <% 
                if (MemberInfoDeatil != null)
                {
                    ...
                    else if (MemberInfoDeatil.vip1rate > 0)
                    {
                        rate = MemberInfoDeatil.vip1rate.ToString();
                    }
                    else if (MemberInfoDeatil.vip2rate > 0)
                    {
                        rate = MemberInfoDeatil.vip2rate.ToString();
                    }
                    else if (MemberInfoDeatil.vip3rate > 0)
                    {
                        rate = MemberInfoDeatil.vip3rate.ToString();
                    }
                    else if (MemberInfoDeatil.vip4rate > 0)
                    {
    ...
    <% if (string.IsNullOrEmpty(cardno))
       ...
       <% if (cardList.Count > 0 && (cardList[0].IncreaseType == 1 || cardList[0].IncreaseType == 2) && cardList[0].BuyMoney > 0)
          {   %>
           <a class="hyk-btn" href='/MemberCard/CardList/<%=ViewData["hId"] %>?key=<%=ViewData["weixinID"] %>@<%=ViewData["userWeiXinID"]%>'>购买会员卡</a>
          <%}
          else
          { %>
