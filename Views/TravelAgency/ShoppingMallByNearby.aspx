...
<body class="yu-bpad90r">
	...
	<section class="yu-grid yu-lrpad20r yu-h65r yu-bor bbor yu-alignc yu-bgw yu-bmar10r">
 ...
 <footer class="screen-bottom yu-grid yu-alignc yu-f26r yu-c22">
 	<div class="yu-overflow">
 		<div class="yu-grid yu-alignc yu-j-c sort-btn">
 			<p class="yu-rmar10r" id="sortName">距离优先</p>
 			<p class="arr"></p>
 		</div>
 	</div>
 	<div class="yu-overflow">
 ...
 <div class="mask sort-mask">
 	<div class="mask-inner ">
 		<ul class="yu-f26r sort-list">
 			<li class="yu-grid yu-alignc" onclick="ChangeSort('推荐排序')">
 				<p class="iconfont yu-w70r yu-textc"></p>
 				<p class="yu-overflow yu-bor bbor yu-h65r yu-l65r">推荐排序</p>
 			</li>
 			<li class="yu-grid yu-alignc yu-blue" onclick="ChangeSort('距离优先')">
        ...
        function GetCommodityInfo() {
            ...
            $.ajax({
                ...
                if (newdata.length == 0) {
                    ...
                    if (CommodityTypeName == "附近" && '<%=ViewData["type"]%>' != "") {
                        CommodityTypeName = "附近"+newdata[0].CommodityTypeName;
                    }
        ...
        geolocation.getCurrentPosition(function (r) {
            if (this.getStatus() == BMAP_STATUS_SUCCESS) {
                ...
                geoc.getLocation(r.point, function (rs) {
                    ...
                    selectCity = r.point.lng + ',' + r.point.lat;
//                    GetCommodityInfo();
                    GetProductsInfo();
