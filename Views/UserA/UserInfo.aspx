			...
			<section class="content2">
				...
				<div class="pg__ucenter">
					...
					<div class="uc__account-info">
						...
						<div class="submit-btn" style="bottom:inherit">
							<a href="javascript:void(0)"  id="svae_msg">保存</a>
						</div>
           ...
           $(function () {
               ...
               $('#svae_msg').on('click', function () {
                   ...
                   $.post("/User/SaveUserInfo", tmp, function (data) {
                       if (data.error == '0') {
                           layer.msg('保存成功！');
                           location.href = '/UserA/Index/<%=ViewData["hId"] %>?key=<%=ViewData["weixinID"] %>@<%=user.WeiXinNO %>';
                       } else {
