<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<dynamic>" %>
 ...
 <% 
     ...
     if (key.Contains('@'))
     {
         list=hotel3g.Models.DishOrderLogic.GetAddressList(key.Split('@')[1]).FindAll(a=>a.addressType==2);
         memberphone=hotel3g.Models.DishOrderLogic.GetMemberPhone(key.Split('@')[1]);
     }
     hotel3g.Models.OrderAddress model = list.Find(a => a.isSelected == true && a.addressType == 2);
     model = model == null ? new hotel3g.Models.OrderAddress() : model;
    if (model.AddressID == 0&& list.Count>0) 
    {
        model = list[0];
    }
...
<section class="yu-tpad10">
            ...
            <%--<div class="yu-grid yu-h60 yu-line60 yu-bor bbor yu-rpad10"  style="display:none">
			...
			<div class="yu-grid yu-h60 yu-line60 yu-bor bbor yu-rpad10 dish-address" style="display:none">
			...
			<div class="yu-grid yu-h60 yu-line60 yu-rpad10 yu-alignc dish-address" style="display:none">
				<p class="yu-w60 yu-font14 yu-rmar10">地址</p>
				<p class="yu-overflow">
					<input type="text" placeholder="用餐位置"  id="RoomNo" name="RoomNo" class="input-type2" value='<%=model.RoomNo %>'/>
				</p>
				<p class="close-type1"></p>
			</div>--%>

            <div class="express-type yu-bgfc kuaidi-address">
            ...
            <input type="hidden" name="address-type" id="address-type" value="2"/>
</section>
<!--旅行社-->
<script>
    ...
    $(function () {
        ...
        $(".name-select").children("p").on("click", function () {
            ...
            var t = 2; // $(this).children(".adtype").val();
