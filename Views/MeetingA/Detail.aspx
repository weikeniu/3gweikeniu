...
<% 
    ...
    {
        Response.Redirect(string.Format("/meetingA/Index/{0}?key={1}@{2}", hotelid, weixinID, userWeiXinID));
    }
...
<body>
    ...
    <%string bodyclass = ""; %>
     ...
     <section class="show-body <%=bodyclass %>">
			...
			<section class="content2 yu-bpad120r <%=bodyclass %>">
				...
				<div class="tab-con">
					<ul class="tab-nav yu-grid yu-bor bbor type3 yu-alignc yu-bmar20r">
    ...
    <script>
        ...
        function GetRateJson() {
            ...
            $.ajax({
                url: '/MeetingA/GetRateList/' + '<%=hotelid %>',
                type: 'post',
                ...
                success: function (data) {
                    ...
                    if (_json['success']) {
                        ...
                        if (paytype == 0) {
                            ...
                            gohref = '/UserA/MyOrders/<%=hotelid %>?key=<%=weixinID %>@<%=userWeiXinID %>';
