...
<head runat="server">
    ...
    <script type="text/javascript" src="<%=ViewData["jsUrl"] %>/Scripts/fontSize.js?v=1.1"></script>
      <script src="<%=ViewData["jsUrl"] %>/Scripts/drag.js" type="text/javascript"></script>
    <script src="<%=ViewData["jsUrl"] %>/Scripts/js.js" type="text/javascript"></script>
</head>
<body class="o-f-auto">
   ...
   <%--  <%Html.RenderPartial("HeaderA", viewDic) ;%>--%>
	...
	<section class="yu-bgw yu-bmar20r">
		<div class="yu-h100r yu-lrpad10 yu-l100r yu-bor bbor yu-arr">
            <div class="yu-c99 yu-f30r yu-grid yu-alignc" onclick="window.location.href='/DishOrder/DishOrderIndex/<%=ViewData["hId"] %>?key=<%=ViewData["key"] %>'">
...
//                    { 
//                      window.location.href= "/DishOrder/DishOrderIndex/<%=ViewData["hId"] %>?key=<%=ViewData["key"] %>&storeId=<%=ViewData["storeId"] %>&orderCode=<%=ViewData["orderCode"] %>";
//                    }else{
//                        $("#tishi_sure").hide();
